...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 23:10:02 2020
...
while True:
    ...
    # only single label 
    class_labels = ['avec mask','sans mask']
    ...
    yolo_model = cv2.dnn.readNetFromDarknet('yolotinyv3_medmask_demo/yolov3-tiny_obj.cfg','weights/yolov3-tiny_obj_2000.weights')
    ...
    for max_valueid in max_value_ids:
        ...
        cv2.putText(img_to_detect, predicted_class_label, (start_x_pt, start_y_pt-5), cv2.FONT_HERSHEY_SIMPLEX, 0.75, box_color, 2)
